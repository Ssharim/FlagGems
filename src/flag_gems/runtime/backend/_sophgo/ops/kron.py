...
def kron_kernel(
    ...
    c_ptr,
    map_ptr,
    batch_size: tl.int32,  # changed to int32
    M: tl.int32,  # changed to int32
    N: tl.int32,  # changed to int32
    M1: tl.int32,  # changed to int32
    M2: tl.int32,  # changed to int32
    N1: tl.int32,  # changed to int32
    N2: tl.int32,  # changed to int32
    a_stride_0: tl.int32,  # changed to int32
    a_stride_1: tl.int32,  # changed to int32
    b_stride_0: tl.int32,  # changed to int32
    b_stride_1: tl.int32,  # changed to int32
    c_stride_0: tl.int32,  # changed to int32
    c_stride_1: tl.int32,  # changed to int32
    a_batch_stride: tl.int32,  # changed to int32
    b_batch_stride: tl.int32,  # changed to int32
    c_batch_stride: tl.int32,  # changed to int32
